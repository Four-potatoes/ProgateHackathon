...
### 게임 이름 : K-Cluture Hub
- **요약** : 한국 문화와 친해질 수 있는 카드 뒤집기 게임 및 AI 학습 퀴즈 구현 (K-Cluture & AI 학습 접목)
...
- **백엔드 DB 활용 방식** : 입력 받은 로그인 정보를 기반으로 플레이, 캐릭터 구매, 배지 수집, 랭킹 등의 기록을 공유
...
- **게임 아이디어** : 아래 제시된 아이디어를 기반으로 게임 진행을 구현
  ...
  - 경쟁력 및 학습 의욕 향상을 이끌어내기 위해 배지 수집 및 랭킹 기능 도입
